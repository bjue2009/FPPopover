...
@synthesize landscapeContentSize = _landscapeContentSize;
@synthesize landscapeOrigin = _landscapeOrigin;
@synthesize portraitContentSize = _portraitContentSize;
@synthesize portraitOrigin = _portraitOrigin;
...
- (void)setPortraitOrigin:(CGPoint)point {
    [self setPortraitOrigin:point animated:NO];
}
...
- (void)setPortraitContentSize:(CGSize)size {
    [self setPortraitContentSize:size animated:NO];
}
...
- (void)setLandscapeOrigin:(CGPoint)point {
    [self setLandscapeOrigin:point animated:NO];
}
...
- (void)setLandscapeContentSize:(CGSize)size {
    [self setLandscapeContentSize:size animated:NO];
}
...
- (void)willPresentNewPopover:(NSNotification*)notification {
    if (notification.object != self) {
        if ([self.delegate respondsToSelector:@selector(presentedNewPopoverController:shouldDismissVisiblePopover:)]) {
            [self.delegate presentedNewPopoverController:notification.object shouldDismissVisiblePopover:self];
        }
    }
}
